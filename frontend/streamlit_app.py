    ...
    if "current_page" in st.session_state:
        ...
        if st.session_state.current_page == "edit_team":
            ...
            st.markdown(
                ...
                - **Used:** {total_spent:,.2f} 
                - **Remaining:** <span style="color:{'red' if remaining_budget < -0.05 else 'green'}">{remaining_budget:,.2f}</span>
                """,
                unsafe_allow_html=True,
            )
            ...
            if selected_count == 15 and remaining_budget >= -0.05:
                st.markdown("---")
